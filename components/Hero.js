...
function Hero() {
    const style = {
        backgroundImage: `linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(https://s3.amazonaws.com/rm3.photos.prod.readmedia.com/students/4451965/cover-original/c-mountains-matterhorn-restricted.jpg?1518738193)`,
    }
  ...
  <div className="flex flex-col space-y-10 text-center hero-content text-neutral-content">
    <div className="max-w-md">
      ...
      <p data-aos="fade-up" className="mb-5 text-lg opacity-70">
        ...
        <ArrowDownIcon className='text-center animate-bounce h-10' id="about"/>
  </div>
</div>
     </div>
    )
