    ...
    return (
        <div className="flex flex-col justify-center h-52 items-center bg-[#222222] space-y-4">
            <div className="flex space-x-2">
                <a className="rounded-none p-2 text-4xl hover:scale-110 hover:bg-blue-900 transition-all ease-out bg-[#333333]"><FaLinkedin/></a>
                <a className="hover:bg-blue-900 rounded-none hover:scale-110 transition-all ease-out  p-2 text-4xl bg-[#333333]"><AiFillGithub/></a>
                <a className="hover:bg-blue-900 rounded-none hover:scale-110 transition-all ease-out p-2 text-4xl bg-[#333333]"><AiFillGithub/></a>
                <a className="hover:bg-blue-900 rounded-none hover:scale-110 transition-all ease-out p-2 text-4xl bg-[#333333]"><AiFillGithub/></a>
            </div>
